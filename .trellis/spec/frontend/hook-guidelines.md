...
Keep hooks browser-enhancement focused. `useSelectionInput` imports `selectInstallation` rather than duplicating policy. There is no client-side GitHub fetching.
