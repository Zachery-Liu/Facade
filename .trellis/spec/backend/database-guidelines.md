...
Release-shaped data is runtime-validated in `src/manifest/release-page-manifest.ts`, passed as in-memory values to `src/core/select-installation.ts`, and exercised in `test/release-page.test.tsx`. None of these modules persists data.
