...
describe('product theme', () => {
  ...
  it('keeps legacy candidate uncertainty explicit', () => { expect(selectInstallation({ ...manifest, assets: [] }, {}).status).toBe('no-match'); expect(selectInstallation(manifest, { os: 'windows' }).status).toBe('needs-input'); });
});
